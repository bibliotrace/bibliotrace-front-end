...
import IhChildrensLogo from "../assets/branding.svg?react";
...
const NavBar = ({ useDarkTheme, showTitle, bgColor, textColor, showNavButtons = true, onHomeClick, back = false }) => {
  ...
  return (
    <div className="flex flex-row w-full items-center justify-between px-4 print:hidden" style={{ backgroundColor: bgColor, color: textColor }}>
