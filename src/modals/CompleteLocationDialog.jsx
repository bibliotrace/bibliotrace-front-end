...
export default function CompleteLocationDialog({
  completeLocationDialog,
  currentLocation,
  completeLocation,
}) {
  return (
    <dialog className="rounded-md p-8 border-2 border-darkPeach" ref={completeLocationDialog}>
      ...
      <p className="text-center mb-5 ">
        Auditing for location {currentLocation.location_name} will be marked complete and cannot be
        undone.
      </p>
